...
Full-stack engineer working primarily in **TypeScript** — React and Next.js on the front end, Node.js (NestJS) and PostgreSQL on the back end.
...
- [**ThisCatDoesNotExist**](https://github.com/VioletLeon/ThisCatDoesNotExist) — procedurally generated CSS cats from seed data; the same seed always renders the same cat.
- [**LeonWebDesigns**](https://github.com/VioletLeon/LeonWebDesigns) — web design studio site built with Next.js.
